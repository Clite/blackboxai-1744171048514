        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden mb-6">
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="<?= BASE_URL ?>/admin/courses/create.php" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            ...
                            <?php foreach ($allCourses as $course): ?>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500"><?= substr($course['description'], 0, 50) ?>...</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php 
                                        $instructor = $user->getUserById($course['instructor_id']);
                                        echo $instructor ? $instructor['first_name'] . ' ' . $instructor['last_name'] : 'N/A';
                                        ?>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="<?= BASE_URL ?>/admin/courses/edit.php?id=<?= $course['id'] ?>" class="text-blue-500 hover:text-blue-700 mr-3">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <a href="<?= BASE_URL ?>/admin/courses/delete.php?id=<?= $course['id'] ?>" class="text-red-500 hover:text-red-700" onclick="return confirm('Are you sure you want to delete this course?')">

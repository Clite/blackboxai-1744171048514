...
// Check if question ID and exam ID are provided
...
if (!$examData || !$questionData || $questionData['exam_id'] != $examId) {
    redirect(BASE_URL . '/admin/exams.php');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        if ($question->updateQuestion(
            ...
            redirect(BASE_URL . "/admin/exams/questions.php?id=$examId&updated=1");
        } else {
...
<head>
    ...
    <title>Edit Question - <?= SITE_NAME ?></title>
    ...
    <main class="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6">
                ...
                <h2 class="text-xl font-semibold text-gray-800 mb-6">Edit Question for: <?= $examData['title'] ?></h2>

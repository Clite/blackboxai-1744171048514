...
$courseToEdit = $course->getCourseById($courseId);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        if ($course->updateCourse(
            ...
            redirect(BASE_URL . '/admin/courses.php?updated=1');
        } else {
...
<head>
    ...
    <title>Edit Course - <?= SITE_NAME ?></title>
    ...
    <main class="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6">
                ...
                <h2 class="text-xl font-semibold text-gray-800 mb-6">Edit Course: <?= $courseToEdit['title'] ?></h2>
